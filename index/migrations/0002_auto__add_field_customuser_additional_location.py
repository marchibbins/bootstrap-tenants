...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.additional_location'
        db.add_column(u'index_customuser', 'additional_location',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.additional_location'
        db.delete_column(u'index_customuser', 'additional_location')
    ...
    models = {
        ...
        u'index.customuser': {
            ...
            'additional_location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
